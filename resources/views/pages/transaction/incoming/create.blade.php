...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="mb-0">Rekam Surat Masuk Baru</h5>
            <small class="text-muted">Isi formulir di bawah ini untuk mengarsipkan surat yang diterima.</small>
        </div>
        ...
        <form action="{{ route('transaction.incoming.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <x-input-form name="reference_number" :label="__('model.letter.reference_number')" placeholder="Nomor pada surat..."/>
                    </div>
                    <div class="col-md-4">
                        <x-input-form name="agenda_number" :label="__('model.letter.agenda_number')" placeholder="No. Agenda (Urut)..."/>
                    </div>
                ...
                <h6 class="fw-bold text-primary mb-3"><i class="bx bx-time-five me-1"></i> Asal & Waktu</h6>
                <div class="row g-3">
                    <div class="col-md-6">
                        <x-input-form name="from" :label="__('model.letter.from')" placeholder="Surat dari (Instansi/Perorangan)..."/>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <x-input-form name="note" :label="__('model.letter.note')" placeholder="Catatan tambahan / Disposisi awal (Opsional)"/>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-1">Bisa upload banyak file sekaligus. Maksimal 2MB per file.</small>
