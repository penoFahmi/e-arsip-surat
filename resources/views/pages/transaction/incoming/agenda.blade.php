...
@section('content')
    ...
    <div class="card mb-5">
        <div class="card-header">
            <h5 class="card-title mb-4">Filter Buku Agenda Masuk</h5>
                ...
                @if($data->count())
                    ...
                    @foreach($data as $agenda)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('transaction.incoming.show', $agenda) }}" class="fw-bold text-dark">
                            ...
                            <td>
                                <span class="d-inline-block text-truncate" style="max-width: 200px;" title="{{ $agenda->from }}">
                                    {{ $agenda->from }}
                                </span>
                            </td>
                            ...
                            <td colspan="4" class="text-center py-5">
                                <div class="mb-3">
                                    <div class="d-inline-flex align-items-center justify-content-center bg-label-secondary rounded-circle" style="width: 80px; height: 80px;">
                                        <i class='bx bx-book-content text-secondary' style="font-size: 2.5rem;"></i>
                                    </div>
                                </div>
                                <h6 class="text-muted">Tidak ada data agenda masuk pada periode ini.</h6>
                                <p class="small text-muted">Silakan sesuaikan filter tanggal di atas.</p>
                            </td>
                        </tr>
                    </tbody>
                @endif
