...
@section('content')
    <x-breadcrumb :values="[__('menu.transaction.menu'), __('menu.transaction.incoming_letter'), __('menu.general.view')]">
        ...
        <div class="mt-4 pt-2">
            ...
            <div class="divider divider-start">
                <div class="divider-text fw-bold text-uppercase text-primary">
                    <i class="bx bx-list-check me-1"></i> Detail Informasi
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8 mb-3">
                            <span class="badge bg-label-primary">#{{ $data->agenda_number }}</span>
                        </dd>
                        ...
                        <dt class="col-sm-4 text-muted text-uppercase small fw-bold mb-3">{{ __('model.letter.from') }}</dt>
                        <dd class="col-sm-8 mb-3 text-dark fw-bold">{{ $data->from }}</dd>
                    </dl>
                </div>
