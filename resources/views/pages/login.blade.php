...
<head>
    ...
    <title>Login Petugas | BKAD Arsip Surat</title>
    ...
    <style>
        body, html { height: 100%; overflow-x: hidden; background-color: #f5f5f9; }
        ...
        .login-branding { position: relative; z-index: 2; color: white; text-align: center; padding: 2rem; }
        .login-right { background: white; display: flex; align-items: center; justify-content: center; padding: 2rem; }
        .login-form-container { width: 100%; max-width: 400px; }

        /* Tombol & Link */
        .btn-primary { background-color: #0d47a1; border-color: #0d47a1; }
        .btn-primary:hover { background-color: #002171; border-color: #002171; }
        a { color: #0d47a1; }
    </style>
</head>
    ...
    <div class="row g-0 login-row">
        ...
        <div class="col-lg-7 col-md-6 d-none d-md-flex login-left">
            <div class="login-branding">
                <img src="{{ asset('logo-black.png') }}" alt="Logo BKAD" style=" invert(1); max-width: 120px; margin-bottom: 20px;">
                <h2 class="text-white fw-bold mb-1">E-Arsip Surat</h2>
                <h4 class="text-white fw-light">Badan Keuangan & Aset Daerah</h4>
            </div>
        </div>
        ...
        <div class="col-lg-5 col-md-6 login-right">
            <div class="login-form-container">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted">Silakan masuk ke akun petugas arsip Anda.</p>
                </div>
