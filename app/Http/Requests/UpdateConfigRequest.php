...
class UpdateConfigRequest extends FormRequest
{
    ...
    public function attributes(): array
    {
        return [
            ...
            'name_of_the_head_of_the_institution' => __('model.config.name_of_the_head_of_the_institution'),
            'nip_of_the_head_of_the_institution' => __('model.config.nip_of_the_head_of_the_institution'),
        ];
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'pic' => ['required'],
            'name_of_the_head_of_the_institution' => ['required'],
            'nip_of_the_head_of_the_institution' => ['required'],
        ];
    }
}
